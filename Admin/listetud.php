...
$classe=$_SESSION['classe'];
 ...
 $con = $ac->connection();
  ...
  $req2=$con->prepare("SELECT * FROM `etudiant`  WHERE `FK_ID_CLASSE`='$classe' ");
  $req2->execute();
  $data2 = $req2->fetchAll();
  ...
  foreach ($data2 as $key ) {if ($id) {
   ...
   <form method="POST" action="pageaffecetud.php">
                                                ...
                                                <td><input type="text" name="" value="'.$key['Matricule'].'" disabled >
                                                    <input type="hidden" name="matetud" value="'.$key['Matricule'].'"></td>

                                                <td><input type="text" name="" value="'.$key['Nom_Etud'].'" disabled>
                                                    <input type="hidden" name="etudnom" value="'.$key['Nom_Etud'].'"> </td>
