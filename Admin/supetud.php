...
$req4=$con->prepare("SELECT * FROM `etudiant` WHERE `FK_ID_CLASSE` IS NOT NULL ORDER BY `FK_ID_CLASSE`,`Nom_Etud`");
  $req4->execute();
  $data4 = $req4->fetchAll();
