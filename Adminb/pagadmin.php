  ...
  foreach ($data as $key ) {
   ...
   <form method="POST" action="pagadmin.php">
                                                ...
                                                <td><input type="text" name="" value="'.$key['Id_Prof'].'" disabled >
                                                    <input type="hidden" name="matprof" value="'.$key['Id_Prof'].'"></td>
                                                ...
                                                <td><input type="text" name="" value="'.$key['Prenom_Prof'].'" disabled>
                                                    <input type="hidden" name="profprenom" value="'.$key['Prenom_Prof'].'" disabled> </td>
                                                <td class="text-right"> <select name="classeprof"> 
                                                                        <option>L1A</option>
                                                                        <option>L1B</option>
                                                                        <option>L1C</option>
                                                                        <option>L2A</option>
                                                ...
                                                <td class="text-right"> <button type="submit" class="btn btn-info data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Affecter salle</button> </td>
